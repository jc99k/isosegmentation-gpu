...
class CDelaunay_3D_Cuda_XGraph_Adaptor : public CDelaunay
{
public:
	...
	typedef int4 NodeEdgesType;
	typedef int3 FacetsType;
	typedef int4 CellVerticesType;
	typedef float3 PointCoordsType;
	typedef float4 BaryCoordsType;

	typedef int4 NeighborsType;
	typedef int SimilarityType;

	typedef cudaArray TexDataType;
