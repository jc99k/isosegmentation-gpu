#ifndef ISOSEGMENTATION_CUDA_IMAGE2D_H
#define ISOSEGMENTATION_CUDA_IMAGE2D_H

#include "XBases.h"

class CImage_2D_Cuda_XGraph_Adaptor : public CImage
{
public:
...
#endif //ISOSEGMENTATION_CUDA_IMAGE2D_H